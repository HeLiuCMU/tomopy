...
MOCK_MODULES = ['numpy', 'scipy', 'scipy.misc', 'h5py', 'matplotlib', 'matplotlib.pylab', 'scikit-image', 'skimage.io', 'numpydoc']
...
texinfo_documents = [
  ...
  Argonne, 
  project, 
  'TomoPy: toolbox to perform tomographic data processing and image reconstruction.',
  'Miscellaneous'),
]
