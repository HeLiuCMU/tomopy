...
from tomopy.algorithms.recon.pml3da import pml3da
from tomopy.algorithms.recon.pml3db import pml3db
...
def _pml2d(self, emission=False, 
    ...
    if data.max() < 2.: # somehow normalized?
        data *= 1e4

    # Initialize and perform reconstruction.
    data_recon = pml2d(data, theta, center, num_grid, iters, beta, delta, init_matrix)
...
def _pml3da(self, emission=False, 
         iters=1, num_grid=None, 
    ...
    # Initialize and perform reconstruction.
    data_recon = pml3da(data, theta, center, num_grid, iters, beta, delta, beta1, delta1, regw, init_matrix)

    # Update log.
    self.logger.debug("pml3da: emission: " + str(emission))
    self.logger.debug("pml3da: iters: " + str(iters))
    self.logger.debug("pml3da: center: " + str(center))
    self.logger.debug("pml3da: num_grid: " + str(num_grid))
    self.logger.debug("pml3da: beta: " + str(beta))
    self.logger.debug("pml3da: delta: " + str(delta))
    self.logger.debug("pml3da: beta1: " + str(beta1))
    self.logger.debug("pml3da: delta1: " + str(delta1))
    self.logger.debug("pml3da: regw: " + str(regw))
    self.logger.info("pml3da [ok]")
...
def _pml3db(self, emission=False, 
         iters=1, num_grid=None, 
    ...
    # Initialize and perform reconstruction.
    data_recon = pml3db(data, theta, center, num_grid, iters, beta, delta, beta1, delta1, regw1, regw2, init_matrix)

    # Update log.
    self.logger.debug("pml3db: emission: " + str(emission))
    self.logger.debug("pml3db: iters: " + str(iters))
    self.logger.debug("pml3db: center: " + str(center))
    self.logger.debug("pml3db: num_grid: " + str(num_grid))
    self.logger.debug("pml3db: beta: " + str(beta))
    self.logger.debug("pml3db: delta: " + str(delta))
    self.logger.debug("pml3db: beta1: " + str(beta1))
    self.logger.debug("pml3db: delta1: " + str(delta1))
    self.logger.debug("pml3db: regw1: " + str(regw1))
    self.logger.debug("pml3db: regw2: " + str(regw2))
    self.logger.info("pml3db [ok]")
...
setattr(XTomoDataset, 'pml3da', _pml3da)
setattr(XTomoDataset, 'pml3db', _pml3db)
